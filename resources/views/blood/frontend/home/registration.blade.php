                        ...
                        <form action="{{ route('frontend.signup') }}" method="post" class="appoinment-form"> 
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <input type="text" name="name" id="your_name" class="form-control" placeholder="Name" value="{{old('name')}}" required>
                                    @if( $errors->has('name'))
                                        <span class="text-danger">{{ $errors->first('name') }}</span>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="email" name="email" id="your_email" class="form-control" placeholder="Email" value="{{old('email')}}">
                                    @if( $errors->has('email'))
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <input type="text" name="phone" id="your_phone" class="form-control" placeholder="Phone" value="{{old('phone')}}" required>
                                    @if( $errors->has('phone'))
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="date" name="last_donate_date" id="last_donate_date" class="form-control" placeholder="Last Donate Date" value="{{old('last_donate_date')}}" required>
